...
function Placeorder() {
    ...
    const placeOrder = () => {
        axios
            .get('https://productsandservices.herokuapp.com/place-order')
            .then((response) => {
    ...
    const placeOrders = (meth) => {
        axios
            .post('https://productsandservices.herokuapp.com/place-order', {
                meth,
                order: input,
            })
            .then((response) => {
    ...
    const delet = () => {
        axios
            .post('https://productsandservices.herokuapp.com/delete')
            .then((result) => {
    ...
    async function displayRazorpay() {
        ...
        const options = {
            key: 'rzp_test_wRs1QW9pU0kcUb', // Enter the Key ID generated from the Dashboard
        ...
        script.onload = async () => {
            try {
                ...
                const options = {
                    ...
                    description: 'A Good place to buy',
                    // order_id: 'order_DBJOWzybf0sJbb',
                    handler: async function (response) {
                        placeOrders('online');
                    },
